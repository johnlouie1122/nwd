...
class DeceasedMain extends StatefulWidget {
  const DeceasedMain({super.key});

  @override
  State<DeceasedMain> createState() => _DeceasedMainState();
}

class _DeceasedMainState extends State<DeceasedMain> {
  ...
  Future<void> chooseFile1() async {
    ...
    if (result != null) {
      setState(() {
        deathCertificate = result.files.single.name;
        deathCertificatebyte = result.files.single.bytes;
      });
    }
  }
  ...
  Future<void> submitFile() async {
    ...
    final deathCertificateName = deathCertificate!;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  fileButton(
                      deathCertificate, 'Death Certificate', chooseFile1),
                  const SizedBox(height: 10),
