...
class ChangeMeterList extends StatefulWidget {
  const ChangeMeterList({super.key});

  @override
  State<ChangeMeterList> createState() => _ChangeMeterListState();
}

class _ChangeMeterListState extends State<ChangeMeterList> {
  ...
  Future<void> fetchServiceData() async {
    final response = await http
        .get(Uri.parse('http://localhost/nwd/admin/get_servicelist.php?table=change_meter'));
                                    ...
                                    children: [
                                      ...
                                      TableRow(children: [
                                        ...
                                        Text('$contactNumber',
                                            textAlign: TextAlign.center),
                                        Text('$status',
                                            textAlign: TextAlign.center, style: TextStyle(color: _getStatusColor(status)),),
                                      ])
                                    ],
                                  )
                                ],
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  QuickAlert.show(
                                    ...
                                    onConfirmBtnTap: () {
                                      updateStatus(id, 'DECLINED', 'change_meter');
                                  ...
                                  QuickAlert.show(
                                    ...
                                    onConfirmBtnTap: () {
                                      QuickAlert.show(
                                        ...
                                        onConfirmBtnTap: () {
                                          updateStatus(id, 'APPROVED', 'change_meter');
                                          Navigator.of(context).push(
                                            MaterialPageRoute(
                                              builder: (BuildContext context) {
                                                return const ChangeMeterList();
