...
class CalibrationList extends StatefulWidget {
  const CalibrationList({super.key});

  @override
  State<CalibrationList> createState() => _CalibrationListState();
}

class _CalibrationListState extends State<CalibrationList> {
  ...
  Future<void> fetchServiceData() async {
    final response = await http.get(Uri.parse(
        'http://localhost/nwd/admin/get_servicelist.php?table=meter_calibration'));
