...
class BasicDetailsMainApplicant extends StatefulWidget {
  const BasicDetailsMainApplicant({super.key});

  @override
  BasicDetailsMainApplicantState createState() =>
      BasicDetailsMainApplicantState();
}

class BasicDetailsMainApplicantState extends State<BasicDetailsMainApplicant> {
